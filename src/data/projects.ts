...
export const conceptProjects: ConceptProject[] = [
  ...
  },
  {
    id: 'mini-dragon',
    number: '04',
    category: 'FANTASY / CRIATURA',
    title: 'Mini Dragon',
    shortTitle: 'Dragon',
    description: 'Uma criatura fantástica para mostrar curvas, detalhes repetidos e geometrias complexas que ganham presença quando vistas em 360°.',
    application: 'Colecionáveis, RPG e decoração',
    materialHint: 'Modelo local otimizado para web',
    visual: 'sword',
    modelUrl: '/assets/models/mini-dragon.glb',
    sourceName: 'Arquivo 3D fornecido para o protótipo',
    license: 'Origem/licença não informadas',
  },
  {
